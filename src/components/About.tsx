        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              We're on a mission to build a community of skillful, self-reliant
              individuals. We offer structured, accessible training programs
              that empower learners to not only grow but to guide others through
              our Train-the-Trainer approach.
            </p>

            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              All our trainings are hosted on the{" "}
              <strong>ShuraForAll.org</strong> platform — a hub for
